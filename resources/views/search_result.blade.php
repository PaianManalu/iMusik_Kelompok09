...
<head>
    ...
    <div class="main">
        ...
        <div class="video-container">
            ...
            @if(isset($search) && stripos($video['nama'], $search) !== false)
            <div class="video"></div>
            @else
            <div class="video-wrapper">
                ...
                <div class="video-title">{{$video['nama']}}</div>
                <p>Artist: {{ $video['artist'] }}</p>
                <p>Deskripsi: <span class="video-deskripsi">{{$video['deskripsi']}}</span></p>
                <p>Jumlah Pemutar: <span class="video-jumlah-pemutaran">{{$video['jumlah pemutaran']}}</span></p>
            </div>
            @endif
            @endforeach
        </div><br><br><br><br>
